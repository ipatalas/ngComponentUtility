...
export class BindingProvider implements vsc.CompletionItemProvider {
    ...
    public provideCompletionItems = (document: vsc.TextDocument, position: vsc.Position/*, token: vsc.CancellationToken*/): vsc.CompletionItem[] => {
        ...
        return this.provideBindingCompletions(component, existingBindings, document, position, startIndex);
    }

    private provideBindingCompletions = (component: Component, existingBindings: Object, document: vsc.TextDocument, position: vsc.Position, startIndex: number): vsc.CompletionItem[] => {
